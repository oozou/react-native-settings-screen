...
export default class SettingsScreen extends Component {
    ...
    state = {
        items: [
            ...
            {type: 'disclosure', title:'Wi-Fi', rightText: 'Oozou'},
            {type: 'disclosure', title:'Bluetooth', rightText: 'On'},
            {type: 'disclosure', title: 'Mobile Data'},
            {type: 'disclosure', title: 'Personal Hotspot', rightText: 'Off'},
            {type: 'disclosure', title: 'VPN', rightText: 'Not Connected'},
            {type: 'space', height: 36},
